...
/**
 * Query string parameters used to filter the results of a {@link org.connectedsystems.ObservationsAPI#getObservations(ObservationsQueryBuilder)} request.
 */
public class ObservationsQueryBuilder extends QueryStringBuilder {
     ...
     */
    public void datastream(List<String> datastream) {
